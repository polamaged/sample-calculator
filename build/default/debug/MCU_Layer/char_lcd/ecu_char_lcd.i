# 1 "MCU_Layer/char_lcd/ecu_char_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCU_Layer/char_lcd/ecu_char_lcd.c" 2

# 1 "MCU_Layer/char_lcd/ecu_char_lcd.h" 1
# 11 "MCU_Layer/char_lcd/ecu_char_lcd.h"
# 1 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 11 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 11 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h" 1
# 12 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h"
...
# 12 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h" 2
...
# 13 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h" 2
...
# 15 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\include\\c99\\stdbool.h" 1 3
# 16 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h" 2
# 26 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/../../MCAL_Layer/config.h"
...
# 12 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 28 "MCU_Layer/char_lcd/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW,
    GPIO_HIGH
}Logic_t;
...
# 11 "MCU_Layer/char_lcd/ecu_char_lcd.h" 2
# 35 "MCU_Layer/char_lcd/ecu_char_lcd.h"
typedef struct{
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
# 2 "MCU_Layer/char_lcd/ecu_char_lcd.c" 2
...
# 24 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_initialize (const lcd_4bit_t *_lcd_){
    ...
    if(((void*)0) == _lcd_){
        ...
        ret = lcd_4bit_send_command(_lcd_, 0x38);
        _delay((unsigned long)((5)*(4000000/4000.0)));
        ret = lcd_4bit_send_command(_lcd_, 0x38);
        _delay((unsigned long)((150)*(4000000/4000000.0)));
        ret = lcd_4bit_send_command(_lcd_, 0x38);

        ret = lcd_4bit_send_command(_lcd_, 0x01);
        ret = lcd_4bit_send_command(_lcd_, 0x02);
        ret = lcd_4bit_send_command(_lcd_, 0x06);
        ret = lcd_4bit_send_command(_lcd_, 0x0C);
        ret = lcd_4bit_send_command(_lcd_, 0x28);
        ret = lcd_4bit_send_command(_lcd_, 0x80);
...
# 65 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_command (const lcd_4bit_t *_lcd_ ,uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 90 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_char_data (const lcd_4bit_t *_lcd_ ,uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 117 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_char_data_position (const lcd_4bit_t *_lcd_ ,uint8 row ,uint8 column , uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 139 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_string (const lcd_4bit_t *_lcd_ ,uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 164 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_string_position (const lcd_4bit_t *_lcd_ ,uint8 row ,uint8 column , uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 191 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_4bit_send_custome_chr (const lcd_4bit_t *_lcd_ ,uint8 row ,uint8 column , const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    if(((void*)0) == _lcd_){
        ...
        ret = lcd_4bit_send_command(_lcd_, (0x40 +(mem_pos*8)));
...
# 218 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_initialize (const lcd_8bit_t *_lcd_){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_data_pins_counter = 0;
    if(((void*)0) == _lcd_){
        ...
        _delay((unsigned long)((20)*(4000000/4000.0)));
        ret = lcd_8bit_send_command(_lcd_, 0x38);
        _delay((unsigned long)((5)*(4000000/4000.0)));
        ret = lcd_8bit_send_command(_lcd_, 0x38);
        _delay((unsigned long)((150)*(4000000/4000000.0)));
        ret = lcd_8bit_send_command(_lcd_, 0x38);

        ret = lcd_8bit_send_command(_lcd_, 0x01);
        ret = lcd_8bit_send_command(_lcd_, 0x02);
        ret = lcd_8bit_send_command(_lcd_, 0x06);
        ret = lcd_8bit_send_command(_lcd_, 0x0C);
        ret = lcd_8bit_send_command(_lcd_, 0x38);
        ret = lcd_8bit_send_command(_lcd_, 0x80);
    }


    return ret;
}
# 257 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_command (const lcd_8bit_t *_lcd_ ,uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 283 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_char_data (const lcd_8bit_t *_lcd_ ,uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_pin_counter = 0;
    if(((void*)0) == _lcd_){
...
# 311 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_position (const lcd_8bit_t *_lcd_ ,uint8 row ,uint8 column , uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 333 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_string (const lcd_8bit_t *_lcd_ ,uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 358 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_string_position (const lcd_8bit_t *_lcd_ ,uint8 row ,uint8 column , uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_){
        ret = (Std_ReturnType)0x00;
...
# 383 "MCU_Layer/char_lcd/ecu_char_lcd.c"
Std_ReturnType lcd_8bit_send_custome_chr (const lcd_8bit_t *_lcd_ ,uint8 row ,uint8 column , const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_lcd_counter = 0;
    if(((void*)0) == _lcd_){
        ...
        ret = lcd_8bit_send_command(_lcd_, (0x40 +(mem_pos*8)));
        for(l_lcd_counter = 0 ; l_lcd_counter<8 ; l_lcd_counter++){
...
static Std_ReturnType lcd_8bit_set_cursor (const lcd_8bit_t *_lcd_, uint8 row , uint8 coulmn){
    ...
    coulmn--;
    switch (row){
        case 1 : ret = lcd_8bit_send_command(_lcd_ , (0x80 + coulmn));
        break;
        case 2 : ret = lcd_8bit_send_command(_lcd_ , (0xc0 + coulmn));
        break;
        case 3 : ret = lcd_8bit_send_command(_lcd_ , (0x94 + coulmn));
        break;
        case 4 : ret = lcd_8bit_send_command(_lcd_ , (0xd4 + coulmn));
        break;
        default : ;
    }
    return ret;
...
static Std_ReturnType lcd_4bit_set_cursor (const lcd_4bit_t *_lcd_, uint8 row , uint8 coulmn){
    ...
    coulmn--;
    switch (row){
        case 1 : ret = lcd_4bit_send_command(_lcd_ , (0x80 + coulmn));
        break;
        case 2 : ret = lcd_4bit_send_command(_lcd_ , (0xc0 + coulmn));
        break;
        case 3 : ret = lcd_4bit_send_command(_lcd_ , (0x94 + coulmn));
        break;
        case 4 : ret = lcd_4bit_send_command(_lcd_ , (0xd4 + coulmn));
        break;
        default : ;
    }
    return ret;
